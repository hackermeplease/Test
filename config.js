...
module.exports = {
   ...
   BOT_INFO: process.env.BOT_INFO || "Test", //YourName;BotName;Image/VideoLink
   SUDO: process.env.SUDO || "254790375710,254740007567",
   ANTICALL: process.env.ANTICALL || false,
   PPRESENCE: process.env.PRESENCE || "available", // "unavailable", "available", "composing", "recording", "paused"
   TIME_ZONE: process.env.TIME_ZONE || "Africa/Kenya",
   LOGS: toBool(process.env.LOGS) || true,
   ANTILINK_ACTION: process.env.ANTI_LINK || "kick",
   BRANCH: "master",
   WARN_COUNT: 3,
   AUTHOR: process.env.AUTHOR || "Test",
   ANTIWORDS: process.env.ANTIWORDS || "badword1,badword2,badword3",
   PACKNAME: process.env.PACKNAME || "Test",
